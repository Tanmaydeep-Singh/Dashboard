    ...
    return (
        <div className="overflow-x-auto bg-white shadow-md rounded-lg">
            ...
            <table className="w-full ">
                <thead className="bg-[#F5F4FF] py-4 px-6">
                    <tr>
                        <th className="py-3 px-6 text-left text-lg font-semibold ">Recent Activity</th>
                        <th className="py-3 px-6 text-left text-md font-medium text-gray-600 flex"> <span>View</span>
                            <Image src={'/icons/arrow-right.png'} width={20} height={20} alt="arrow" /></th>
                    </tr>
                </thead>
